function rvm --description='Ruby enVironment Manager'
  ...
  # This finds where RVM's root director is and sources scripts/rvm from within it.  Then loads RVM in a clean environment and dumps the environment variables it generates out for us to use. 
